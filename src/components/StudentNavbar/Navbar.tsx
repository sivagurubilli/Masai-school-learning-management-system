...
{/* this is part is like when user enter into smaller screens the navbar appear on left  side as side bar  */}
    ...
    <div id="navbar-mobile"   className={clicked ? "navbar-mobile active":"navbar-mobile"}>
        <li><NavLink  to ="/lectures" >Lectures</NavLink></li>
          <li><NavLink  to ="/assignments" >Assignments</NavLink></li>
          <li><NavLink  to ="/admin/signup" >Quizzes</NavLink></li>
           <li><NavLink to ="/tickets" >Tickets</NavLink></li>
           <li><NavLink  to ="/discussons" >Discussons</NavLink></li>
          <li><NavLink  to ="/notifications" >Notifications</NavLink></li>
          <li><NavLink  to ="/messages" >Messages</NavLink></li>
          <li><NavLink  to ="/electives" >Electives</NavLink></li>
           <li><NavLink  to ="/announcements" >Announcements</NavLink></li>
           <li><NavLink  to ="/courses" >Courses</NavLink></li>
           <Divider borderColor="gray.300"/>
           <Text color="black"  padding="10px"><NavLink to="/user/profile" >Profile</NavLink></Text>

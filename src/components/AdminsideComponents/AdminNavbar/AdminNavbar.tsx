        ...
        <Box boxShadow='sm' >
         ...
         <Hide below='md'>
           <Flex w="70%" justifyContent={"space-around"} align="center" >
               <Box className='li' >
              <NavLink   to ="/admin/lectures" >Lectures</NavLink></Box>
               <Box className='li' ><NavLink   to ="/admin/assignments" >Assignments</NavLink></Box>
              <Box className='li' > <NavLink   to ="/admin/quizzes" >Quizzes</NavLink></Box>
             <Box className='li' ><NavLink   to ="/admin/tickets" >Tickets</NavLink></Box>
             <Box className='li' > <NavLink   to ="/admin/discussions" >Discussions</NavLink></Box>
              <Box className='li' ><NavLink   to ="/admin/notifications" >Notifications</NavLink></Box>
            <Box className='li' ><NavLink   to ="/admin/messages" >Messages</NavLink></Box>
           <Box className='li' ><NavLink   to ="/admin/electives" >Electives</NavLink></Box>
           <Box className='li' ><NavLink   to ="/admin/announcements" >Announcements</NavLink></Box>
           <Box className='li' ><NavLink   to ="/admin/questions" >Questions</NavLink></Box>
           <Box className='li' ><NavLink   to ="/admin/problems" >problems</NavLink></Box>
...
{/*  this part is about display hamburger in menu item for small screeens  */}
    ...
    <Show  below="md" >
         <Box  ><i id ="bar" onClick={handleclick}  className={clicked ? "fas fa-times":"fas fa-bars"}></i></Box>
    </Show>
  </Flex>
...
{/* this is part is like when user enter into smaller screens the navbar appear on left side as side bar  */}
    ...
    <li> <NavLink  to ="/admin/lectures" >Lectures</NavLink></li>
        <li>  <NavLink  to ="/admin/assignments" >Assignments</NavLink></li>
          <li> <NavLink  to ="/admin/admin/signup" >Quizzes</NavLink></li>
         <li> <NavLink  to ="/admin/tickets" >Tickets</NavLink></li>
         <li> <NavLink  to ="/admin/discussons" >Discussons</NavLink></li>
          <li> <NavLink  to ="/admin/notifications" >Notifications</NavLink></li>
        <li> <NavLink  to ="/admin/messages" >Messages</NavLink></li>
        <li> <NavLink  to ="/admin/electives" >Electives</NavLink></li>
        <li> <NavLink  to ="/admin/announcements" >Announcements</NavLink></li>
        <li><NavLink  to ="/admin/questions" >Questions</NavLink></li>
        <li><NavLink  to ="/admin/problems" >problems</NavLink></li>
           <Divider borderColor="gray.300"/>
        <Text color="black"  padding="10px"><NavLink  to="/admin/profile" >Profile</NavLink></Text>
        <Text color="black"  padding="10px"><NavLink  to="/transcript" >Transcript </NavLink></Text>

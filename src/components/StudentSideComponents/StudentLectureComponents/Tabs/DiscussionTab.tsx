  ...
  return (
    <Tabs isFitted variant="enclosed" defaultIndex={1}>
      ...
      <TabPanels>
        <TabPanel></TabPanel>
        <TabPanel>
          <Box h="300px" m="20px" boxShadow="md" p="6" rounded="md" bg="white">
            <Flex bg="RGBA(0, 0, 0, 0.04)" h="70px" alignItems="center">
              <Input w="350px" placeholder="Title" ml="20px" bg="white" />
              <Select w="350px" ml="20px" bg="white">
                <option value="">Is open</option>
                <option value="">Is close</option>
              </Select>
              <Button bg="black" color="white" ml="100px">
                RESET
              </Button>
            </Flex>
            <EmptyTab />

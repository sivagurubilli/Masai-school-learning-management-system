import {
 ...
 import { ICreateLectureValues,ILecturePostResponse,LecturePostService ,LectureEditService} from "../../../Services/LectureServices";
...
import { useParams } from "react-router-dom";
 ...
 const AdminLectureEdit = () => {
    const [LectureEditValues, setLectureEditValues] = useState<ICreateLectureValues>({
      title: "",
      batch: "",
      section: "",
      type: "",
    ...
    const handleChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
      ...
      setLectureEditValues({ ...LectureEditValues, [name]: value });
    };
